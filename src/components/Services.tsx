...
const Services = () => {
  ...
  const calculations = [
    "IPBD/SPBD/NSPBD Busduct Sizing", "HT/LT Cable Sizing", "CT&PT Sizing",
    "DC Battery Sizing", "EDG/BSDG Sizing", "Earthing Calculation",
    "GCB Sizing", "Lightning Protection", "NGR Sizing",
    "HT/LT Switchgear Sizing", "HT/LT Transformer Sizing", "UPS Sizing",
    "Lighting Calculation", "Cable Tray Loading", "ACSR Conductor Sizing",
    "Sag Tension Calculation", "Busbar Sizing Calculation", "Load Flow",
    "E-tap Study", "Relay Setting"
  ];

  const layouts = [
    "Cable Routing Layout", "Earthing Layout", "Lighting Layout",
    "Lightning Protection Layout", "Equipment Layout",
    "Plant Communication Layout", "Cathodic Protection"
  ];

  const controlSchemes = [
    "HT Switchgear Control Scheme", "LT Switchgear Control Scheme",
    "HT Motor Control Scheme", "LT Motor Control Scheme"
  ];

  const diagrams = [
    "Key Single Line Diagram", "HT Switchgear Single Line Diagram",
    "LT Switchgear Single Line Diagram", "DCDB", "ACDB", "UPS",
    "GIS Single Line Diagram"
  ];

  const switchyard = [
    "GIS Switchyard 132/220/400 kV", "AIS Switchyard 132/220/400/765kV",
    "GIS/AIS Cable Routing Layout", "GIS/AIS Earthing Layout",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              Engineering converts your ideas and concepts into highly accurate 2D CAD drawings. 
              We offer industry-aligned CAD drafting services with a combination of skilled, 
              qualified, and experienced CAD professionals equipped with the latest tools.
            </p>
        ...
        <div className="bg-gradient-card rounded-2xl p-8">
          ...
          <Tabs defaultValue="calculations" className="w-full">
            ...
            <TabsContent value="seminars">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  "Generator", "Power Transformer", "MV/LV Switchgear", "Busduct",
